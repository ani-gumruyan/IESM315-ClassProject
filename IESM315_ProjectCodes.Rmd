...
```{r}
data <- read.csv(file = "IESM315_CP_Data.csv")
...
# Apply the new_drop_outliers function to the Rand1to50 column
data_1to50 <- data_1to50 %>%
  mutate(Rand1to50 = new_drop_outliers(Rand1to50)) %>% 
  na.omit()
